...
import com.canso.csbi.model.enums.UpdateStatusEnum;
import com.canso.csbi.model.vo.BiResponse;
...
public class ChartController {
    ...
    public BaseResponse<BiResponse> genChartByAiAsync(@RequestPart("file") MultipartFile multipartFile,
        ...
        chart.setChartData(csvData);
        chart.setChartType(chartType);
        chart.setStatus(UpdateStatusEnum.WAIT.getValue());
        chart.setUserId(loginUser.getId());
        boolean saveResult = chartService.save(chart);
        ThrowUtils.throwIf(!saveResult, ErrorCode.SYSTEM_ERROR, "图表保存失败");
        ...
        CompletableFuture.runAsync(() -> {
            ...
            updateChart.setStatus(UpdateStatusEnum.RUNNING.getValue());
            ...
            // 定义状态为枚举值
            updateChartResult.setStatus(UpdateStatusEnum.SUCCEED.getValue());
