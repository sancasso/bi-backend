package com.canso.csbi.common;

import com.canso.csbi.constant.RabbitMqConstant;
...
public class RabbitUtils implements RabbitTemplate.ConfirmCallback, RabbitTemplate.ReturnsCallback {
    ...
    public void sendSms(SmsDTO smsDTO) {
        ...
        try {
            ...
            this.smsDTO = smsDTO;
            // 将消息投递到MQ，并设置消息的一些参数
            rabbitTemplate.convertAndSend(RabbitMqConstant.sms_exchange, RabbitMqConstant.sms_routingKey, smsDTO, message -> {
            ...
            redisTemplate.opsForHash().put(RabbitMqConstant.MQ_PRODUCER, messageId, smsDTO);
    ...
    public void confirm(CorrelationData correlationData, boolean b, String s) {
        if (b) {
            ...
            redisTemplate.opsForHash().put(RabbitMqConstant.MQ_PRODUCER, finalId, this.smsDTO);
        }
    }
